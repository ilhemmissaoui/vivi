...
const ActionForm = ({
  ...
  actionAction,
  cibleAction,
  handleStartActionChange,
  handleEndActionChange,
  handleActionActionChange,
  handleCibleActionChange,
  addAction,
  modalTab,
  arrowModalTabChange,
}) => {
  ...
  return (
    <Form onSubmit={addAction} className="mt-4">
      ...
      <div className="mb-2">
        ...
        <Form.Control
          ...
          value={startAction}
          disabled
          onChange={handleStartActionChange}
        />
      </div>
      <div className="my-2">
        <label htmlFor="inputField" className="mb-1">
      ...
      <div className="flex my-2">
        <div className="flex flex-col justify-start">
          ...
          <Form.Control
            ...
            value={actionAction}
            required
            onChange={handleActionActionChange}
          />
        </div>
        ...
        <div className="flex flex-col justify-start">
          ...
          <Form.Control
            ...
            value={cibleAction}
            required
            onChange={handleCibleActionChange}
          />
        </div>
      </div>
    </Form>
