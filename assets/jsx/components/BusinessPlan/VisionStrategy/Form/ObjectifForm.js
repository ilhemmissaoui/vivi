...
const ObjectifForm = ({
  ...
  actionObjectif,
  cibleObjectif,
  handleStartObjectifChange,
  handleEndObjectifChange,
  handleActionObjectifChange,
  handleCibleObjectifChange,
  addObjectif,
}) => {
  ...
  return (
    <Form onSubmit={addObjectif} className="mt-4">
      ...
      <div className="mb-2">
        ...
        <Form.Control
          ...
          value={startObjectif}
          disabled
          onChange={handleStartObjectifChange}
        />
      </div>
      <div className="">
        <label htmlFor="inputField" className="mb-1">
        ...
        <Form.Control
          ...
          placeholder="Fin"
          value={endObjectif}
          min={getNextDay(startObjectif)}
          required
          onChange={handleEndObjectifChange}
        />
      </div>
      <div>
        <div className="flex my-2">
          <div className="flex flex-col justify-start">
            ...
            <Form.Control
              ...
              type="text"
              placeholder="Action"
              value={actionObjectif}
              required
              onChange={handleActionObjectifChange}
            />
          </div>
          ...
          <div className="flex flex-col justify-start">
            ...
            <Form.Control
              ...
              value={cibleObjectif}
              required
              onChange={handleCibleObjectifChange}
            />
          </div>
        </div>
      </div>
