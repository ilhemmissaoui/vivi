...
class EquipeRepository extends ServiceEntityRepository
{
    ...
    public function findDirigentObjet($idDirigeant,$SalaireEtchargeSocialDirigents)
    {
        return $this->createQueryBuilder('u')
            ->andWhere('u.id = :idDirigeant')
            ->setParameter('idDirigeant', $idDirigeant)
  
            ->innerJoin('u.salaireEtchargeSocialDirigents', 's')
  
            ->andWhere('s.id = :SalaireEtchargeSocialDirigents')
